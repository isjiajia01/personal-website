...
import { dictionaryKeys, getDictionary, Language } from "@/dictionaries";
...
export function generateStaticParams() {
  return dictionaryKeys.flatMap((lang) =>
    lifeCategories.map((category) => ({ lang, categorySlug: category.slug })),
  );
}
